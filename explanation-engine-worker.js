...
var KOMODO_TEP = function() {
    function loadKomodoTep(console, WasmPath, Module) {
        ...
        var asm = createWasm();
        var ___wasm_call_ctors = Module["___wasm_call_ctors"] = asm["N"];
        var _CEE_InitWithOpts = Module["_CEE_InitWithOpts"] = asm["P"];
        var _CEE_Init = Module["_CEE_Init"] = asm["Q"];
        var _CEE_Dispose = Module["_CEE_Dispose"] = asm["R"];
        var _CEE_DisposeGame = Module["_CEE_DisposeGame"] = asm["S"];
        var _CEE_Play = Module["_CEE_Play"] = asm["T"];
        var _CEE_GetLastMove = Module["_CEE_GetLastMove"] = asm["U"];
        var _CEE_NewFeature = Module["_CEE_NewFeature"] = asm["V"];
        var _CEE_DisposeFeature = Module["_CEE_DisposeFeature"] = asm["W"];
        var _CEE_Run = Module["_CEE_Run"] = asm["X"];
        var _CEE_Stop = Module["_CEE_Stop"] = asm["Y"];
        var _CEE_Join = Module["_CEE_Join"] = asm["Z"];
        var _CEE_EnableNotifications = Module["_CEE_EnableNotifications"] = asm["_"];
        var _CEE_DisableNotifications = Module["_CEE_DisableNotifications"] = asm["$"];
        var _CEE_WaitForNotification = Module["_CEE_WaitForNotification"] = asm["aa"];
        var _CEE_StopNotificationWaiting = Module["_CEE_StopNotificationWaiting"] = asm["ba"];
        var _CEE_GetLastError = Module["_CEE_GetLastError"] = asm["ca"];
        var _CEE_ClearLastError = Module["_CEE_ClearLastError"] = asm["da"];
        var _CEE_EnableLog = Module["_CEE_EnableLog"] = asm["ea"];
        var _CEE_DisableLog = Module["_CEE_DisableLog"] = asm["fa"];
        var _CEE_IsValidGamePoint = Module["_CEE_IsValidGamePoint"] = asm["ga"];
        var ___errno_location = Module["___errno_location"] = asm["ha"];
        var _malloc = Module["_malloc"] = asm["ia"];
        var _free = Module["_free"] = asm["ja"];
        var __ZN3TEP7ktprintENSt3__212basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE = Module["__ZN3TEP7ktprintENSt3__212basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE"] = asm["ka"];
        var __ZN3TEP2pbEy = Module["__ZN3TEP2pbEy"] = asm["la"];
        var __ZN3TEP2pbEyNS_6SquareE = Module["__ZN3TEP2pbEyNS_6SquareE"] = asm["ma"];
        var __ZN3TEP2pbEyNS_6SquareES0_ = Module["__ZN3TEP2pbEyNS_6SquareES0_"] = asm["na"];
        var _uci_command = Module["_uci_command"] = asm["oa"];
        var _init = Module["_init"] = asm["pa"];
        var ___getTypeName = Module["___getTypeName"] = asm["qa"];
        var __embind_initialize_bindings = Module["__embind_initialize_bindings"] = asm["ra"];
        var _emscripten_builtin_memalign = Module["_emscripten_builtin_memalign"] = asm["sa"];
        var ___trap = Module["___trap"] = asm["ta"];
        var stackSave = Module["stackSave"] = asm["ua"];
        var stackRestore = Module["stackRestore"] = asm["va"];
        var stackAlloc = Module["stackAlloc"] = asm["wa"];
        var ___start_em_js = Module["___start_em_js"] = 8585012;
        var ___stop_em_js = Module["___stop_em_js"] = 8585296;
...
onmessage = function(event) {
    ...
    if (message && message.type === 'initKomodoWorker' && message.wasmPath) {
        if (workerInitialized) {
            postMessage({ type: 'initStatus', message: "[Worker]: Komodo TEP already initialized." });
            return;
        }
        ...
        try {
            ...
            postMessage({ type: 'error', message: "[Worker Error during initKomodoWorker]: " + (e.message || e), stack: e.stack });
